...
abstract class Initial<T> implements MapsState<T> {
...
abstract class Loading<T> implements MapsState<T> {
...
abstract class Success<T> implements MapsState<T> {
...
abstract class Failure<T> implements MapsState<T> {
...
abstract class Error<T> implements MapsState<T> {
