...
abstract class AppLocalizations {
  ...
  /// No description provided for @restEmailMessage.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @onBoard_1.
  ///
  /// In en, this message translates to:
  /// **'Welcome to Tager Paraffin'**
  String get onBoard_1;

  /// No description provided for @onBoard_2.
  ///
  /// In en, this message translates to:
  /// **'We are here to help you'**
  String get onBoard_2;

  /// No description provided for @onBoard_3.
  ///
  /// In en, this message translates to:
  /// **'Let\'s get started'**
